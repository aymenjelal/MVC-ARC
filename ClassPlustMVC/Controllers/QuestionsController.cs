...
namespace ClassPlustMVC.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Questions.Include(q => q.Course).Include(q => q.Student);
        ...
        public async Task<IActionResult> Create([Bind("QuestionId,QuestionContent")] Question question, int? id)
        {
            ...
            ViewData["StudentId"] = new SelectList(_context.Users, "Id", "Id", question.StudentId);
            return View(question);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("QuestionId,StudentId,CourseId,PostDate,QuestionContent")] Question question)
        {
